...
contract Bingo {
    ...
    function checkWinning(
        ...
        if (
            ...
            (gameRounds[_gameRound].players[_player].gameBoardMatchs[0] == 1 &&
                gameRounds[_gameRound].players[_player].gameBoardMatchs[6] ==
                1 &&
                gameRounds[_gameRound].players[_player].gameBoardMatchs[18] ==
                1 &&
                gameRounds[_gameRound].players[_player].gameBoardMatchs[24] ==
                1) ||
            ...
            (gameRounds[_gameRound].players[_player].gameBoardMatchs[4] == 1 &&
                gameRounds[_gameRound].players[_player].gameBoardMatchs[8] ==
                1 &&
                gameRounds[_gameRound].players[_player].gameBoardMatchs[16] ==
                1 &&
                gameRounds[_gameRound].players[_player].gameBoardMatchs[20] ==
                1)
        ) {
            return (true);
        }
    ...
    function setConfigBetAmountForBINGO(
        uint256 _betAmountForBINGO
    ) public onlyAdmin {
        betAmountForBINGO = _betAmountForBINGO;
    }

    function setConfigReturnBet(bool _returnBet) public onlyAdmin {
        returnBet = _returnBet;
    }

    function setConfigMaxPlayerNum(uint256 _maxPlayerNum) public onlyAdmin {
